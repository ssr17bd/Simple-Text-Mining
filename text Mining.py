...
# load reviews data
with open("D:\\360DigiTMG\\TRAINING\\week 5\\oneplusseven.txt","r",encoding="utf-8") as sw:
    rev_string = sw.read()
...
with open("D:\\360DigiTMG\\TRAINING\\week 5\\positive-words.txt","r") as pos:
...
with open("D:\\360DigiTMG\\TRAINING\\week 5\\negative-words.txt", "r") as neg:
